...
router.post("/:id/return", (0, validate_1.validateParams)(booking_validator_1.getBookingParamsSchema), (0, validate_1.validate)(booking_validator_1.returnProductSchema), (req, res) => bookingController.returnProduct(req, res));
router.post("/:id/cancel", (0, validate_1.validateParams)(booking_validator_1.getBookingParamsSchema), (0, validate_1.validate)(booking_validator_1.cancelBookingSchema), (req, res) => bookingController.cancelBooking(req, res));
...
router.get("/:id/preview-cancellation-refund", (0, validate_1.validateParams)(booking_validator_1.getBookingParamsSchema), (req, res) => bookingController.previewCancellationRefund(req, res));
