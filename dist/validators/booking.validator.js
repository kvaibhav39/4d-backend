...
exports.listBookingsQuerySchema = exports.getBookingParamsSchema = exports.addPaymentSchema = exports.updateBookingStatusSchema = exports.updateBookingSchema = exports.createBookingSchema = exports.checkConflictsSchema = void 0;
...
exports.checkConflictsSchema = joi_1.default.object({
    ...
    toDateTime: joi_1.default.date().iso().greater(joi_1.default.ref("fromDateTime")).required().messages({
...
exports.createBookingSchema = joi_1.default.object({
    ...
    customerPhone: joi_1.default.string().trim().max(20).allow("", null).optional().messages({
    ...
    additionalItemsDescription: joi_1.default.string().trim().max(1000).allow("", null).optional().messages({
...
exports.updateBookingStatusSchema = joi_1.default.object({
