...
class CategoryController {
    async listCategories(req, res) {
        try {
            ...
            (0, logger_1.logError)("List categories error", error);
    ...
    async getCategory(req, res) {
        try {
            ...
            (0, logger_1.logError)("Get category error", error);
            res.status(500).json({ message: "Internal server error" });
        }
    }
    ...
    async updateCategory(req, res) {
        try {
            ...
            (0, logger_1.logError)("Update category error", error);
            res.status(500).json({ message: "Internal server error" });
        }
    }
    async deleteCategory(req, res) {
        try {
            ...
            (0, logger_1.logError)("Delete category error", error);
            res.status(500).json({ message: "Internal server error" });
        }
    }
    async restoreCategory(req, res) {
        try {
            ...
            (0, logger_1.logError)("Restore category error", error);
            res.status(500).json({ message: "Internal server error" });
        }
    }
}
